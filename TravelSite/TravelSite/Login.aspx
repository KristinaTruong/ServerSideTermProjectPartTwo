		...
		<section id="log">
			<form method="post" runat="server">
				...
				<div class="form-group">
					<asp:TextBox ID="txtUserNm" runat="server" class="form-control" placeHolder="User Name"></asp:TextBox>
				...
				<div class="form-group">
                  ...
                  <asp:Button ID="btnLogin" runat="server" Text="Login" class="btn btn-primary btn-bloc" OnClick="btnLogin_Click" ></asp:Button> 
                   
                 <input type="checkbox" checked="checked" name="remember" class="btn btn-primary btn-bloc" /> Remember me<br />
                <hr />
